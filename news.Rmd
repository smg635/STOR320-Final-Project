...
# AllTheNews <- rbind(read_csv("data/all-the-news/articles1.csv"), read_csv("data/all-the-news/articles2.csv"))
# AllTheNews <- rbind(read_csv("data/all-the-news/articles1.csv"), read_csv("data/all-the-news/articles2.csv"), read_csv("data/all-the-news/articles3.csv"))
...
```
```{r}
AllTheNews <- AllTheNews %>% select(1:month, day, day_of_week, url:polarity)
colnames(AllTheNews)
```
